...
int main(void){
    ...
    // while(1){
        printf("I AM WAITING FOR PROCESS B TO UNBLOCK ME\n");
        sem_wait(&shared_data->semA);   //blocked A
        sem_post(&shared_data->semB);   //unblocked A
        printf("PROCESS B UNBLOCKED ME I AM READY TO RUN\n");
